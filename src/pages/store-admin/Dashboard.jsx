...
import {
  Banknote, Truck, Package, ShoppingCart, PlusSquare, Plus,
  ...
  return (
    <div className="space-y-8 pb-8 transition-colors duration-300">
      ...
      <div className="flex items-center justify-between animate-fade-in">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${isDark ? 'bg-brand/20 text-brand' : 'bg-brand/10 text-brand'}`}>
              Hub: {hubName}
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard icon={<Banknote size={24} className="text-brand" />} label="Revenue" value="KES 13,456.5" subtext="Shipping fees are not included" colorClass="bg-brand/10" className="animate-slide-up animate-stagger-1" />
        ...
        <StatCard icon={<ShoppingBag size={24} className="text-sky-500" />} label="Monthly Earning" value="KES 6,982" subtext="Based in your local time." colorClass="bg-sky-500/10" className="animate-slide-up animate-stagger-4" />
      </div>
          ...
          <div className="h-[350px] w-full relative">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={salesData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                ...
                <YAxis axisLine={false} tickLine={false} tick={{ fill: '#64748b', fontSize: 12 }} tickFormatter={(value) => `KES ${value}`} />
                <Tooltip 
          ...
          <div className="h-[350px] w-full relative">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={revenueData} barGap={2} barCategoryGap="20%">
                ...
                <YAxis axisLine={false} tickLine={false} tick={{ fill: '#64748b', fontSize: 11 }} tickFormatter={(value) => `KES ${value}`} />
